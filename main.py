# main.py — تلگرام بدون parse_mode + پیدا کردن خودکار chat_id + fallback برای صرافی‌ها
...
# ---- پارامترهای استراتژی (ساده برای نمونه) ----
...
def find_chat_id(token, max_tries=5):
    """آخرین chat_id از getUpdates برمی‌گرداند (private یا channel)."""
